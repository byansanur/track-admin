...
public class ActivityMapPetugas extends AppCompatActivity implements OnMapReadyCallback {
...
//    getAllDataLocationLatLng1();
  }

//  private void getAllDataLocationLatLng1() {
...
//    Call<LocationUsersModel> call = mApiServices.loc(2);
...
//  private void initMakers1(List<LocationUsersModel.DatumUser> list) {
...
//  }
  ...
  public void onBackPressed(){
    super.onBackPressed();
    Intent i = new Intent(ActivityMapPetugas.this,HomeActivity.class);
    startActivity(i);
    finish();
  }
